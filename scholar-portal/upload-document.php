...
// At the top of your file, after the session_start() and includes
...
<header class="header">
    ...
    <p>Welcome, <?php echo htmlspecialchars($first_name ?? 'User'); ?>! Upload your required documents for the scholarship application.</p>
</div>
